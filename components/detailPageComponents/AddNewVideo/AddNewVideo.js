    ...
    return (
      <View>
        ...
        <View style={styles.container}>
          ...
          <TouchableOpacity style={styles.iconContainer} onPress={() => this.addNewVideo(this.state.newVideoLink, this.state.newVideoName, listItemID)}>
            <Feather name='plus-circle' size={30} color='#2f95dc' style={{ marginRight: 20 }} />
          </TouchableOpacity>
        </View>
      </View>
    );
...
export default connect(null, mapDispatchToProps)(AddNewVideo)
