...
import { fetchToDoList, setStateForPlusAddNewItem, setPageName } from '../../../actions'
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.center}>
          <View>
            {
              isFetching || isSearching ? <ActivityIndicator size="small" color="black" /> : null
            }
          </View>
          <View>
            {
              isUploaded && !activeList.length && !isSearching ? <Text>Not Found</Text> : null
            }
          </View>
          {
